...
uint8_t SPI_Master_Init(uint32_t clock_rate){
	...
	if 	(clock_divider <=2)	SPCON = 0x70 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=4)	SPCON = 0x71 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=8)	SPCON = 0x72 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=16)	SPCON = 0x73 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=32)	SPCON = 0xF0 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=64)	SPCON = 0xF1 | (CPOL_value<<3) | (CPOL_value <<2);
	else if (clock_divider <=128)	SPCON = 0xF2 | (CPOL_value<<3) | (CPOL_value <<2);
